...
0. Harvest the story first — scribe appends it to vault/stories.md (format in
   agents/scribe.md). stories.md is append-only with no size target: it is the
   permanent record of what the product does, and the streak the dial promotion counts.
