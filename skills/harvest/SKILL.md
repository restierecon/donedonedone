---
name: harvest
description: Turn merged slices into user stories in vault/stories.md and prune them from vault/task-tree.json. Use after slices merge, when the task tree has grown stale with done slices, or when asked to run /harvest.
---
